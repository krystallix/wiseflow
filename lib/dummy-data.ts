...
export const emptyColumns: Record<TaskStatus, Task[]> = {
    todo: [],
    in_progress: [],
    done: [],
    cancel: [],
...
export const initialProjects: Project[] = [
    ...
    },
    {
        id: 'proj-2',
        name: 'Marketing Site',
        description: 'Landing page and campaigns',
        color: '#22c55e',
        created_at: '2026-02-20T08:00:00Z',
    },
];

export const initialTasksByProject: Record<string, Record<TaskStatus, Task[]>> = {
    'proj-1': {
        todo: [
            {
                id: 'task-1',
        ...
        todo: [
            {
                ...
                description: 'Craft compelling headline and feature descriptions',
                category: 'UI/UX Design',
                tag_id: 'D-143',
                status: 'todo',
                priority: 'High',
                ...
                created_at: '2026-02-22T08:00:00Z',
                subtasks: [
                    { id: 'st-7-1', task_id: 'task-7', title: 'Research competitor pages', is_done: true, sort_order: 0 },
                    { id: 'st-7-2', task_id: 'task-7', title: 'Draft hero section', is_done: false, sort_order: 1 },
                ],
            },
        ],
        in_progress: [],
